  ...
  return (
    <footer className="bg-headerBg py-1 shadow-sm">
      <div className="mx-auto max-w-5xl px-4 flex flex-col md:flex-row items-center justify-between text-xs text-white/80">
        ...
        This project makes use of biodiversity occurrence data provided  by the Global Biodiversity Information Facility {" "}
          <a
        ...
        <div>
          ...
          <ul className="list-disc list-inside space-y-0.5">
            ...
            <li>NRCS (Soil Compaction Tolerance, Wetland Indicator, Multifunctional Use)</li>
            <li>USDA National Agroforestry Center (Shade, Flood, Drought Tolerance, Growth Rate, Pollinator Friendly)</li>
